...
酷柏先試行每個品項三種排行榜：單盒＋量販一起比、單盒比價、量販比價。買 1 盒（含附贈）歸單盒，需買 2 盒以上歸量販；先分購買門檻，再在各榜選每個商家最便宜的方案。品項沿用整體至少三站的收錄門檻，子榜不足三家照實顯示，沒有資料則標示尚未收錄。酷柏單片價格無條件捨去至整數後排名，同價以總價較低者優先。單盒與量販方案分別收錄，同一網址的不同購買方案不互相覆蓋。執行 `node test_cooper.cjs` 驗證。
